...
<body data-curpage="recycle" data-curusername="${userName}" data-waferlist="${waferList}" data-currentpage="${currentPage}" data-totalpage="${totalPage}" data-totalcount="${totalCount}">
			...
			<div class="g_bodyin_body">
				<div class="g_bodyin_bodyin">
					<div class="g_bodyin_bodyin_tit bootstro" data-bootstro-title="回收站引导：第三步" data-bootstro-content="<div class='well well-sm'><h4>操作区域</h4><p>在这里您可以永久删除选中数据或者恢复选中数据</p></div>" data-bootstro-placement="bottom" data-bootstro-html="true" data-bootstro-step="2">
						<div class="g_bodyin_bodyin_tit_l"><span class="glyphicon glyphicon-remove" aria-hidden="true" title="永久删除选中"></span><span class="glyphicon glyphicon-share-alt" aria-hidden="true" title="恢复选中"></span></div>
							...
							<tbody>
								...
								<c:forEach var="waferListItem" items="${waferList}" varStatus="status">
									<tr>
										...
										<td class="not_search operate_othertd"><span class="glyphicon glyphicon-trash" aria-hidden="true" data-iid="${waferListItem['wafer_id']}" title="永久删除"></span><span class="glyphicon glyphicon-share-alt" aria-hidden="true" data-iid="${waferListItem['wafer_id']}" title="恢复"></span></td>
