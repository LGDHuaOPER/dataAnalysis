...
(function(root, factory) {
	...
	Paging.prototype = {
		...
		bindToolbar: function() {
			var _this = this;
			var html = $('<li class="ui-paging-toolbar"><select class="ui-select-pagesize" style="display:none;"></select><input type="text" class="ui-paging-count"/><a href="javascript:void(0)" class="Gotojump">跳转</a></li>');
