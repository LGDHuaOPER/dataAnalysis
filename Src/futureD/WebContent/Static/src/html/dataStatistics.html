...
<head>
	...
	<link rel="stylesheet" href="../style/modules/dataStatistics/dataStatistics.css" type="text/css">
</head>
<body data-curpage="dataStatistics">
									...
									<div class="row">
										<div class="col-sm-6 col-md-4 col-lg-4">
											<div class="thumbnail" data-ipage="g_bodyin_bodyin_bottom_2" data-ichart="histogram">
										      	<img src="../img/modules/dataStatistics/1.png" alt="直方图" width="198">
										      	<div class="caption">
										        	<h3>直方图</h3>
										      	</div>
										    </div>
									  	...
									  	<div class="col-sm-6 col-md-4 col-lg-4">
											<div class="thumbnail" data-ipage="g_bodyin_bodyin_bottom_2" data-ichart="boxlinediagram">
										      	<img src="../img/modules/dataStatistics/2.png" alt="箱线图" width="198">
										      	<div class="caption">
										        	<h3>箱线图</h3>
										      	</div>
										    </div>
										...
										<div class="col-sm-6 col-md-4 col-lg-4">
											<div class="thumbnail" data-ipage="g_bodyin_bodyin_bottom_2" data-ichart="CPK">
										      	<img src="../img/modules/dataStatistics/4.png" alt="CPK" width="198">
										      	<div class="caption">
										        	<h3>CPK</h3>
										      	</div>
										    </div>
									...
									<div class="row">
										<div class="col-sm-6 col-md-4 col-lg-4">
											<div class="thumbnail" data-ipage="g_bodyin_bodyin_bottom_2" data-ichart="correlationgraph">
										      	<img src="../img/modules/dataStatistics/5.png" alt="相关性" width="198">
										      	<div class="caption">
										        	<h3>相关性</h3>
										      	</div>
										    </div>
									  	...
									  	<div class="col-sm-6 col-md-4 col-lg-4">
											<div class="thumbnail" data-ipage="g_bodyin_bodyin_bottom_2" data-ichart="wafermap">
										      	<img src="../img/modules/dataStatistics/3.png" alt="晶圆图" width="198">
										      	<div class="caption">
										        	<h3>晶圆图</h3>
										      	</div>
										    </div>
										...
										<div class="col-sm-6 col-md-4 col-lg-4">
											<div class="thumbnail" data-ipage="g_bodyin_bodyin_bottom_2" data-ichart="gaussiandistribution">
										      	<img src="../img/modules/dataStatistics/6.png" alt="高斯分布图" width="198">
										      	<div class="caption">
										        	<h3>高斯分布图</h3>
										      	</div>
										    </div>
	...
	<script src="../script/modules/dataStatistics/dataStatisticsRender.js"></script>
	<script src="../script/libs/drawWaferMap.js"></script>
	<script src="../script/modules/dataStatistics/dataStatistics.js"></script>
</body>
</html>