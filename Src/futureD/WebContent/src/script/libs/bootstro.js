    ...
    (function( bootstro, $, undefined ) {
        ...
        bootstro.stop = function()
        {
            ...
            if (typeof settings.onExit == 'function')
                settings.onExit.call(this,{idx : activeIndex, count: count});
        };
        ...
        bootstro.next = function()
        {
            ...
            if (typeof settings.onStep == 'function')
                settings.onStep.call(this, {idx : activeIndex, direction : 'next', count: count});
            if (activeIndex + 1 == count)
            {
                if (typeof settings.onComplete == 'function')
                    settings.onComplete.call(this, {idx : activeIndex, count: count});//
            }
        };
        ...
        bootstro.prev = function()
        {
            ...
            else
            {
                bootstro.go_to(activeIndex -1);
                if (typeof settings.onStep == 'function')
                    settings.onStep.call(this, {idx : activeIndex, direction : 'prev', count: count});//
            }
        };
        ...
        bootstro._start = function(selector)
        {
            ...
            $elements = $(selector);
            // count  = $elements.size(); // .size()方法从jQuery 1.8开始被废弃
